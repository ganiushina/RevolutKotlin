package ru.alta.revolutkotlin.ui.customviews
...
import u.alta.revolutkotlin.common.getColorRes
...
class ColorPickerView : LinearLayout {
    ...
    var onColorClickListener: (color: Currency.Color) -> Unit = { }
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        Currency.Color.values().forEach { color ->
            addView(
                ColorCircleView(context).apply {
                    ...
                    setOnClickListener { onColorClickListener(it.tag as Currency.Color) }
                })
        }
