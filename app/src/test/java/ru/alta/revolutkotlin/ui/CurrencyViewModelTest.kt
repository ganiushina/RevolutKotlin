...
class CurrencyViewModelTest {
    ...
    fun setup() {
        ...
        every { mockRepository.getCurrencyByName(testCurrency.title) } returns noteLiveData
    ...
    fun `loadNote should return NoteViewState Data`() {
        var result: CurrencyViewState.Data? = null
        val testData = CurrencyViewState.Data(false, testCurrency)
    ...
    fun `deleteNote should return NoteViewState Data wish isDeleted`() {
        var result: CurrencyViewState.Data? = null
        val testData = CurrencyViewState.Data(true, null)
        viewModel.getViewState().observeForever {
            result = it.data
        }
